...
export const FAKESTORE_PRODUCTS: FakeStoreProduct[] = [
  ...
  },
  {
    ...
    price: 599,
    description:
      "21.5 inches Full HD widescreen IPS display and Radeon free Sync technology. Zero-frame design with ultra-thin 4ms response time.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 999.99,
    description:
      "49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR with Quantum Dot technology, HDR support, 144Hz refresh rate and 1ms response time.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 56.99,
    description:
      "Note: The Jackets is US standard size. Material: 100% Polyester. Detachable Liner Fabric: Warm Fleece. 3 in 1 Detachable Design.",
  ...
  },
  {
    ...
    price: 29.95,
    description:
      "100% POLYURETHANE(shell) 100% POLYESTER(lining). Faux leather material for style and comfort. 2 pockets of front.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 7.95,
    description:
      "100% Polyester, Machine wash. Lightweight, roomy and highly breathable with moisture wicking fabric.",
    category: "women's clothing",
